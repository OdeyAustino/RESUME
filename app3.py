...
# --- GENERAL SETTINGS ---
PAGE_TITLE = "Digital CV | Austino Odey"
PAGE_ICON = ":wave:"
...
SOCIAL_MEDIA = {
    "LinkedIn": "https://www.linkedin.com/in/austino-odey-a0757a262?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
    "GitHub": "https://github.com/OdeyAustino",
    "Twitter": "https://x.com/ceegazz?s=21",
}

SOCIAL_MEDIA_ICONS = {
    "LinkedIn": "https://upload.wikimedia.org/wikipedia/commons/0/0e/LinkedIn_Logo_2023.png",
    "GitHub": "https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg",
    "Twitter": "https://upload.wikimedia.org/wikipedia/commons/6/60/Twitter_Logo_2021.svg",
}
...
if selected == "Introduction":
    ...
    # Social media icons only, no names
    social_icons = ""
    for platform, icon_url in SOCIAL_MEDIA_ICONS.items():
        social_icons += f"<a href='{SOCIAL_MEDIA[platform]}' target='_blank'><img src='{icon_url}' width='30' height='30' style='margin-right: 10px;'/></a>"
